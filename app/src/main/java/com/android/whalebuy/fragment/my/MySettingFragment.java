 ...
 *
 */
public class MySettingFragment extends BaseFragment implements View.OnClickListener,IFragmentListener {
    View mRootView;
    ...
    public static MySettingFragment create() {
