...
public class FeedbackFragment extends BaseFragment implements OnClickListener, OnDismissListener {
    @Override
...
public static FeedbackFragment create( ) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mRootView = inflater.inflate(R.layout.mycenter_feedback, container, false);
