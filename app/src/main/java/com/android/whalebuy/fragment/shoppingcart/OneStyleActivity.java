...
import com.android.whalebuy.data.OrderInfo;
...
public class OneStyleActivity extends AppCompatActivity {
    ...
    private int[] iconArr=new int[]{R.drawable.icon1,R.drawable.icon2,R.drawable.icon3};
    ...
    private void initOnclickListener(){
        ...
        elMainOrdercenter.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                Toast.makeText(OneStyleActivity.this,"跳转到订单详细页面:"+childPosition, Toast.LENGTH_SHORT).show();
                return false;
            }
        });
    }
    ...
    private class MyAdapter extends BaseExpandableListAdapter {
        ...
        public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
            if(convertView==null){
                convertView= View.inflate(OneStyleActivity.this,R.layout.parent_view,null);
            }
        ...
        public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
            if(convertView==null){
                convertView= View.inflate(OneStyleActivity.this,R.layout.child_view,null);
            }
            //获取布局控件id
            ...
            btnChildviewEvaluate.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(OneStyleActivity.this,"跳转到"+orderInfo.getName()+"的评价页面", Toast.LENGTH_SHORT).show();
                }
            });
            //设置删除按钮的点击事件
